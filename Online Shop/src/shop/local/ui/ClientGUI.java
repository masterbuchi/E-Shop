...
//	    }, "Shutdown-thread"));
	...
	public void mitarbeiterMainPanel(UUID uuid, Nutzer nutzer) {
		...
		content.add(mitarbeiterArtikelPanel, "width 50%:100%, height 50%:100%");
		this.revalidate();
	}
	...
	public void MitarbeiterDetailAnzeigenPanel(String name) throws ArtikelNichtVorhandenException {
		if (mitarbeiterDetailPanel != null) {
			content.remove(mitarbeiterDetailPanel);
		}
		mitarbeiterDetailPanel = new MitarbeiterDetailPanel(shop, aktuelleUUID, name, this);
		content.add(mitarbeiterDetailPanel);
		this.revalidate();
